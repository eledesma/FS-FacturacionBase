...
class cliente extends fs_model
{
   ...
   public function __construct($c=FALSE)
   {
      ...
      if($c)
      {
         ...
         $this->nombreemp = $c['nombreemp'];
         $this->industriaemp = $c['industriaemp'];
         $this->emailemp = $c['emailemp'];
         $this->telefonoemp = $c['telefonoemp'];
         $this->direccionemp = $c['direccionemp'];
         $this->ciudademp = $c['ciudademp'];
         $this->paisemp = $c['paisemp'];
         $this->fax = $c['fax'];
         $this->email = $c['email'];
         $this->web = $c['web'];
      ...
      if( $this->test() )
      {
         ...
         if( $this->exists() )
         {
            $sql = "UPDATE ".$this->table_name." SET nombre = ".$this->var2str($this->nombre)
                    ...
                    .", nombreemp = ".$this->var2str($this->nombreemp)
                    .", industriaemp = ".$this->var2str($this->industriaemp)
                    .", emailemp = ".$this->var2str($this->emailemp)
                    .", telefonoemp = ".$this->var2str($this->telefonoemp)
                    .", direccionemp = ".$this->var2str($this->direccionemp)
                    .", ciudademp = ".$this->var2str($this->ciudademp)
                    .", paisemp = ".$this->var2str($this->paisemp)
         ...
         else
         {
            $sql = "INSERT INTO ".$this->table_name." (codcliente,nombre,razonsocial,tipoidfiscal,
               cifnif,telefono1,telefono2,fax,email,web,nombreemp,industriaemp,emailemp,telefonoemp,
               direccionemp,ciudademp,paisemp,codserie,coddivisa,codpago,codagente,codgrupo,debaja,
               fechabaja,fechaalta,observaciones,regimeniva,recargo,personafisica) VALUES
                    ...
                    .",".$this->var2str($this->nombreemp)
                    .",".$this->var2str($this->industriaemp)
                    .",".$this->var2str($this->emailemp)
                    .",".$this->var2str($this->telefonoemp)
                    .",".$this->var2str($this->direccionemp)
                    .",".$this->var2str($this->ciudademp)
                    .",".$this->var2str($this->paisemp)
