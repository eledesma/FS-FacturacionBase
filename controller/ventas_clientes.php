...
class ventas_clientes extends fs_controller
{
   ...
   protected function private_core()
   {
      ...
      else if( isset($_POST['cifnif']) ) /// añadir un nuevo cliente
      {
         ...
         $cliente->nombreemp = $_POST['nombreemp'];
         $cliente->industriaemp = $_POST['industriaemp'];
         $cliente->emailemp = $_POST['emailemp'];
         $cliente->telefonoemp = $_POST['telefonoemp'];
         $cliente->direccionemp = $_POST['direccionemp'];
         $cliente->ciudademp = $_POST['ciudademp'];
         $cliente->paisemp = $_POST['paisemp'];
         ...
         if( isset($_POST['telefonoemp']) )
         {
            $cliente->telefonoemp = $_POST['telefonoemp'];
         }
         if( isset($_POST['direccionemp']) )
         {
            $cliente->direccionemp = $_POST['direccionemp'];
         }
         if( isset($_POST['ciudademp']) )
         {
            $cliente->ciudademp = $_POST['ciudademp'];
         }
         if( isset($_POST['paisemp']) )
         {
            $cliente->paiseemp = $_POST['paisemp'];
         }
