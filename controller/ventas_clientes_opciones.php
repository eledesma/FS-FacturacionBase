...
class ventas_clientes_opciones extends fs_controller
{
   ...
   protected function private_core()
   {
      ...
      if( isset($_POST['setup']) )
      {
         ...
         $this->nuevocli_setup['nombre_empresa'] = ( isset($_POST['nombre_empresa']) ? 1 : 0 );
         $this->nuevocli_setup['industria_empresa'] = ( isset($_POST['industria_empresa']) ? 1 : 0 );
         $this->nuevocli_setup['email_empresa'] = ( isset($_POST['email_empresa']) ? 1 : 0 );
         $this->nuevocli_setup['telefono_empresa'] = ( isset($_POST['telefono_empresa']) ? 1 : 0 );
         $this->nuevocli_setup['direccion_empresa'] = ( isset($_POST['direccion_empresa']) ? 1 : 0 );
         $this->nuevocli_setup['ciudad_empresa'] = ( isset($_POST['ciudad_empresa']) ? 1 : 0 );
         $this->nuevocli_setup['pais_empresa'] = ( isset($_POST['pais_empresa']) ? 1 : 0 );
