...
class ventas_cliente extends fs_controller
{
   ...
   protected function private_core()
   {
      ...
      else if( isset($_POST['codcliente']) ) /// modificar cliente
      {
         ...
         $this->cliente->nombreemp = $_POST['nombreemp'];
         $this->cliente->industriaemp = $_POST['industriaemp'];
         $this->cliente->emailemp = $_POST['emailemp'];
         $this->cliente->telefonoemp = $_POST['telefonoemp'];
         $this->cliente->direccionemp = $_POST['direccionemp'];
         $this->cliente->ciudademp = $_POST['ciudademp'];
         $this->cliente->paisemp = $_POST['paisemp'];
